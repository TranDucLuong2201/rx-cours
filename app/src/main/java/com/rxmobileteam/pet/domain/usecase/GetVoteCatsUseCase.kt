...
class GetVoteCatsUseCase @Inject constructor(private val voteRepository: VoteCatRepository) {
  suspend operator fun invoke(sortBy: String, limit: Int): Result<List<Cat>> =
